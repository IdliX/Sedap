...
export default function Dashboard() {
    return (
        <div id="dashboard-container">
            ...
            >
                <button className="bg-green-500 text-white px-4 py-2 rounded-lg mr-2">Add</button>
                <button className="bg-blue-500 text-white px-4 py-2 rounded-lg mr-2">Export</button>
